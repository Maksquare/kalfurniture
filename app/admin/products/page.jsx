      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 bg-gold hover:bg-gold-dark text-primary font-secondary text-[11px] font-bold tracking-widest uppercase rounded-full shadow-[0_4px_20px_rgba(217,182,110,0.3)] transition-all"
          >
            <PiPlus size={16} />
            Add Product
          </button>
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          className="p-2 text-secondary/50 hover:text-gold hover:bg-gold/10 rounded-lg transition-colors"
                          title="Edit"
                        >
