      ...
      <section className="container mb-16 md:mb-24">
        ...
        >
          ...
          <p className="font-secondary text-[16px] md:text-[18px] text-secondary/70 leading-relaxed max-w-2xl">
            Immerse yourself in our meticulously curated spaces. From grand living rooms to serene bedroom sanctuaries, discover the craftsmanship and quality of Phoenix Furniture in person.
          </p>
        </motion.div>
      </section>
